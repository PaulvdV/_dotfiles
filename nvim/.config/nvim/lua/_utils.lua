...
local function _smart_tab(direction)
...
function utils.extract_highlight_color(color_group, scope, cterm_color)
  ...
  if color.foreground ~= nil then
    color.fg = color.fg = string.format("#%06x", color.foreground)
